	...
	*/
	public class KBEngineApp
	{
		...
		*/
		...
		{
			Dbg.ERROR_MSG("KBEngine::Client_onLoginBaseappFailed: failedcode=" + serverErr(failedcode) + "(" + failedcode + ")!");
		...
		*/
		...
		{
			Dbg.ERROR_MSG("KBEngine::Client_onReloginBaseappFailed: failedcode="+ serverErr(failedcode) + "(" + failedcode + ")!");
